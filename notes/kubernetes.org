...
- token files
4190u4122u101-23123, jimit,3,"developer,grophers"

:top:, if I show up with the first field as the Bearer token, I would be authenticated as jimit with the group "developer,grophers"
...
Then you can give (bind) this power (role) to the user jimit for eg
